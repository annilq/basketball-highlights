...
CREATE TABLE "shotDetection" (
	...
	"shooting_percentage" numeric(5, 2) NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "shotEvent" (
	"id" text PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"shot_detection_id" text NOT NULL,
	"frame" integer NOT NULL,
	"is_make" integer NOT NULL,
	"attempts" integer NOT NULL,
	"makes" integer NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE "shotDetection" ADD CONSTRAINT "shotDetection_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shotDetection" ADD CONSTRAINT "shotDetection_team_id_team_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."team"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shotEvent" ADD CONSTRAINT "shotEvent_shot_detection_id_shotDetection_id_fk" FOREIGN KEY ("shot_detection_id") REFERENCES "public"."shotDetection"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "shot_detection_user_id_idx" ON "shotDetection" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "shot_detection_team_id_idx" ON "shotDetection" USING btree ("team_id");--> statement-breakpoint
