# Spec: Basketball Video SaaS Marketing Website

**Status:** Proposed
**Type:** New Capability
**Related Changes:** update-web-basketball-saas

## Overview

This specification defines the requirements for the marketing website content that promotes the basketball video SaaS platform to media and content creators.

## Context

The marketing website serves as the public-facing entry point for potential users. It must clearly communicate the product's value proposition, demonstrate core functionality, and guide users toward sign-up or trial.
...
1. **Interactive demo**: Users cannot upload their own videos in this phase
2. **Video sync**: Original and highlight videos are independent players, not synchronized
3. **Real product integration**: CTAs may link to placeholder signup pages
4. **Real customer testimonials**: Placeholder testimonials if any, not real user quotes
5. **Custom pricing logic**: Pricing is static content, not dynamically generated
6. **Authentication**: No actual user login/signup flow in marketing site
7. **Database integration**: Marketing site remains static (Astro), no backend connections

## Success Criteria

- All pages accessible and render without errors
- No "React Starter Kit" references remain
- Video comparison displays correctly on desktop and mobile
- Content speaks to media & content creators
- Clear CTAs on every page
- SEO basics in place (meta tags, titles, alt text)
- Lint and typecheck pass with zero new errors
- Responsive design works across breakpoints (mobile, tablet, desktop)

## Dependencies

- ShadCN UI components must be properly exported from `@repo/ui`
- Video assets must be available (placeholders acceptable)
- No changes to Astro configuration or build process required

## Future Enhancements

These capabilities are not part of this spec but may be added later:

1. Interactive video upload and processing demo
2. Synchronized playback between original and highlight videos
3. Customer testimonials and case studies
4. Blog/content section for SEO
5. Integration with actual SaaS pricing and signup flow
6. Multi-language support
7. Advanced video player features (slow motion, frame-by-frame)
